...
- **Extracted icon crop references**: `<image href="../icon_detection/crops/<image-stem>/icon_001.png" preserveAspectRatio="xMidYMid meet"/>` when the Design Spec explicitly lists the crop as a candidate reusable asset
